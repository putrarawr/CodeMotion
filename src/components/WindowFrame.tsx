...
import { Minus, Square, X, Plus, FileCode2 } from 'lucide-react';
              ...
              return (
                ...
                >
                  <input
                    ...
                    className="bg-transparent text-xs font-mono outline-none border-none max-w-[110px] truncate"
                    style={{ width: `${Math.max(tab.title.length * 7.5, 40)}px` }}
                  />
                  {tabs.length > 1 && (
                    <button
                      onClick={(e) => {
