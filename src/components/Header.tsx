...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`h-14 flex-shrink-0 w-full border-b px-4 lg:px-6 flex items-center justify-between shadow-xs transition-colors duration-200 z-40 sticky top-0 ${isDark
    ...
    >
      {/* Brand & Logo - Click to return to Landing Page */}
      <Link to="/" className="flex items-center gap-3 no-underline group" title="Return to Landing Page">
        <div
          className={`h-8 w-8 rounded-lg flex items-center justify-center border transition-all ${isDark
        ...
        <div className="flex items-center gap-2">
          <h1 className="text-base font-bold tracking-tight font-sans m-0">CodeSnap</h1>
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          to="/"
          className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium rounded-lg border transition-all no-underline ${isDark
        ...
        <div className="relative" ref={presetsRef}>
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-all ${isDark
          ...
          {showPresetsMenu && (
            <div
              className={`absolute right-0 mt-2 w-56 rounded-xl border shadow-xl p-1.5 z-50 transition-all ${isDark ? 'bg-zinc-900 border-zinc-800 text-zinc-100' : 'bg-white border-zinc-200 text-zinc-900'
                }`}
            >
              ...
              {AESTHETIC_PRESETS.map((preset) => (
                <button
                  ...
                  className={`w-full text-left px-2.5 py-2 rounded-lg text-xs transition-colors flex flex-col gap-0.5 ${isDark ? 'hover:bg-zinc-800 text-zinc-200' : 'hover:bg-zinc-100 text-zinc-900'
                    }`}
                >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-all shadow-xs disabled:opacity-50 ${isDark
              ? 'bg-zinc-900 border-zinc-800 text-zinc-200 hover:bg-zinc-800 hover:text-white'
              : 'bg-zinc-100 border-zinc-300 text-zinc-800 hover:bg-zinc-200'
            }`}
        >
        ...
        <div className="relative" ref={pngDropdownRef}>
          <div
            className={`flex items-center rounded-lg border shadow-xs transition-all overflow-hidden ${isDark
          ...
          >
            ...
            <button
              ...
              disabled={isExporting}
              className={`px-2 py-1.5 border-l transition-colors ${isDark ? 'border-zinc-300 hover:bg-zinc-200' : 'border-zinc-700 hover:bg-zinc-800'
                }`}
            >
          ...
          {showPngDropdown && (
            <div
              className={`absolute right-0 mt-2 w-48 rounded-xl border shadow-xl p-1.5 z-50 transition-all ${isDark ? 'bg-zinc-900 border-zinc-800 text-zinc-100' : 'bg-white border-zinc-200 text-zinc-900'
                }`}
            >
              <button
                onClick={() => handleExportPng(2)}
                className={`w-full text-left px-2.5 py-2 rounded-lg text-xs flex items-center justify-between transition-colors ${isDark ? 'hover:bg-zinc-800' : 'hover:bg-zinc-100'
                  }`}
              >
                <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`w-full text-left px-2.5 py-2 rounded-lg text-xs flex items-center justify-between transition-colors ${isDark ? 'hover:bg-zinc-800 font-semibold' : 'hover:bg-zinc-100 font-semibold'
                  }`}
              >
                <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`w-full text-left px-2.5 py-2 rounded-lg text-xs flex items-center justify-between border-t mt-1 pt-2 transition-colors ${isDark ? 'hover:bg-zinc-800 border-zinc-800' : 'hover:bg-zinc-100 border-zinc-200'
                  }`}
              >
                <div className="flex items-center gap-2">
