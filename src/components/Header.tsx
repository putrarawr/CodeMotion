...
import { Camera, Copy, Download, Sparkles, RefreshCw, FileCode2, Image, ChevronDown, Sun, Moon, Check } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`h-14 flex-shrink-0 w-full border-b px-4 lg:px-6 flex items-center justify-between shadow-xs transition-colors duration-200 z-40 ${
        isDark
